...
//      }
//    }else{
//        //Added by LC, otherwise not occupied space is considered valid and difference is always equal to res if complete map height is free.
//        //Misleading because function isOccupied returns valid points of the map (and does not differ between free and occupied map space)
//        //But how is occupied map space (e.g. walls) filtered out?
//        lastZ = z;
//    }
